 ...
 */
@Controller
@RequestMapping(value = "/web/partnerbonus")
public class PartnerBonusController extends BaseController {

	private static final Log log = LogFactory.getLog(PartnerBonusController.class);
	...
	public Object seniorExecutive(HttpServletRequest request, HttpServletResponse response) {
		...
		return new ModelAndView("/web/profit", map);
	}
