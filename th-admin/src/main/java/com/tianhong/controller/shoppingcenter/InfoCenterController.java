 ...
 */
@Controller
@RequestMapping(value = "/shopping/infocenter")
public class InfoCenterController extends BaseController {

	private static final Log log = LogFactory.getLog(InfoCenterController.class);
	...
	public Object info(HttpServletRequest request, HttpServletResponse response) {
		...
		return new ModelAndView("/shoppingcenter/info", map);
	}
