...
INSERT INTO `t_content` VALUES ('29', '106', '', '', '', '', null, '<p>111111111111111</p>', null, '2016-10-11 11:36:10', '1', '2016-10-11 11:36:17', '1', '0', null, null, null);
...
CREATE TABLE `t_news_center` (
  ...
  `backup3` varchar(1024) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='新闻中心';
...
INSERT INTO `t_picture` VALUES ('114', '106', '3', 'æµè¯ä¸ä¸', 'undefined', null, '1', '1476156965124.png', '2016-10-11 11:36:05', '1', null, null, '0', null, null, null);
