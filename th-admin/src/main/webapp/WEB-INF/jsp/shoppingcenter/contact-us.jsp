...
<head>
	...
	<script src="${basePath }/js/shoppingcenter/contact-us.js?ver=${ver}" type="text/javascript" ></script>
	...
	<div class="rt_content">
		...
		<div class="pop_cont">
			...
			<div class="pop_cont_input">
				<ul>
					<!-- <li><span style="width:70px;text-align: right;" class="ttl">姓名:</span> <input id="popName" style="width:140px;" type="text" class="textbox" /></li> -->
					<li><span style="width:70px;text-align: right;" class="ttl">地址:</span><input id="popJob"  style="width:140px;" type="text" class="textbox" /></li>
					...
					<li><span style="width:70px;text-align: right;" class="ttl">邮箱:</span><input id="popEmail"  style="width:140px;" type="text" class="textbox" /></li>
				</ul>
			</div>
