...
<title>天虹</title>
	...
	<script src="${basePath }/js/web/commonweal.js?ver=${ver}" type="text/javascript"></script>
				...
				<div class="pop_cont_input">
					<ul>
						...
						<li>
							...
							<input id="popSource" style="width: 140px;" type="text" placeholder="请输入来源..." class="textbox" />
						</li>
						<li>
