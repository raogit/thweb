	...
	<div>
		<form action="${basePath }/upload/picture" encType="multipart/form-data" method="post">
			<ul class="ulColumn2" style="text-align: left;">
				<li>
					<span class="item_name" style="width: 120px;">视频名称：</span><input type="text" id="title" name="title"/> 
				</li>
				<li>
					<span class="item_name" style="width: 120px;">视频frash：</span><input type="text" id="picPath" name="picPath" style="width:520px;"/> 
				</li>
				<li><span class="item_name" style="width: 120px;"></span> <input type="button" class="link_btn" onclick="saveVideo()" value="上传"/></li>					
