...
<head>
	...
	<script src="${basePath }/js/web/investment-hotline.js?ver=${ver}" type="text/javascript"></script>
	...
	<div class="rt_content">
		...
		<div class="pop_cont" style="top: 5%;">
			...
			<div class="pop_cont_input">
				<ul>
					<li><span style="width: 70px; text-align: right;" class="ttl">姓名:</span>
						<input id="popName" style="width: 140px;" type="text" placeholder="请输入标题..." class="textbox" />
					</li>
					<li><span style="width: 70px; text-align: right;" class="ttl">电话:</span>
						<input id="popPhone" style="width: 140px;" type="text" placeholder="请输入标题..." class="textbox" />
					</li>
					<li>
						<span style="width: 70px; text-align: right;" class="ttl">e-mail:</span>
						<input id="popEmail" style="width: 140px;" type="text" placeholder="请输入标题..." class="textbox" />
					</li>
					<li><span style="width: 70px; text-align: right;" class="ttl">部门:</span>
						<input id="popDepartment" style="width: 140px;" type="text" class="textbox" />
					</li>
				</ul>
