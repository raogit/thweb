...
<head>
	...
	<script src="${basePath }/js/web/staff-info.js?ver=${ver}" type="text/javascript" ></script>
		...
		<div class="pop_cont">
			...
			<div class="pop_cont_input">
				<ul>
					...
					<li><span style="width:70px;text-align: right;" class="ttl">职位:</span><input id="popJob"  style="width:140px;" type="text" class="textbox" /></li>
