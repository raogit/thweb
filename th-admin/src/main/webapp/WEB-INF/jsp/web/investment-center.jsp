...
<head>
	...
	<script src="${basePath}/js/web/investment-center.js?ver=${ver}" type="text/javascript" ></script>
			...
			<form action="${basePath }/upload/picture" encType="multipart/form-data" method="post">
				<ul class="ulColumn2" style="text-align: left;">
					...
					<li><span class="item_name" style="width: 120px;"></span> <input
						type="button" class="link_btn" onclick="uploadInvestment('fileId',1)" value="上传"/></li>					
					<li id="bannerpicture"> </li>
				</ul>
			</form>
		</div>
		<div style="float:left;width:40%">
			<input type="hidden" value="0" id="contentId" name="contentId" />
			<ul class="ulColumn2" style="text-align: left;">
				<li>
					<span class="item_name" style="width: 120px;">标题：</span><input type="text" id="investmentTitle" name="picTitle"/> 
				</li>
				<li>
					<span class="item_name" style="width: 120px;">描述：</span><input type="text" id="investmentSlogan" name="picTitle"/> 
				</li>
				<li>
					<span class="item_name" style="width: 120px;">内容：</span><textarea id="investmentContent" rows="3" cols="20"></textarea>
				</li>
				<li><span class="item_name" style="width: 120px;"></span> <input type="button" class="link_btn" onclick="saveInvestmentContent()" value="保存"/></li>					
				<li id="bannerpicture"> </li>
			</ul>
