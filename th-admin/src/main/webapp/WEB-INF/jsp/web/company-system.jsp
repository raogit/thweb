	...
	<div class="rt_content">
		...
		<div class="pop_cont" style="top: 5%;">
			...
			<div class="pop_cont_input">
				<ul>
					<li><span style="width: 70px; text-align: right;" class="ttl">版本:</span>
						<input id="popTitle" style="width: 140px;" type="text"" class="textbox" />
					</li>
					<li><span style="width: 70px; text-align: right;" class="ttl">标题:</span>
<!-- 						<textarea id="popContent" rows="10" cols="50"></textarea> -->
						<input id="popContent" style="width: 140px;" type="text"" class="textbox" />
					</li>
					<!-- <li>
						<span style="width: 70px; text-align: right;" class="ttl">报名截止时间:</span>
						<input class="Wdate" type="text" id="eventTime" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',lang:'en'})" name="endTime" style="width: 160px;" />
					</li>
					<li><span style="width: 70px; text-align: right;" class="ttl">采购类型:</span>
						<input id="popBuyType" style="width: 140px;" type="text" class="textbox" />
					</li> -->
				</ul>
				<div id="popUpPicture">
					<form action="${basePath }/upload/image" encType="multipart/form-data" method="post">
						<!-- <ul class="ulColumn2" style="text-align: left;">
							<li><span class="item_name" style="width: 120px;">上传图片：</span><input type="file" id="fileId" name="fileId" />
							</li>
							<li><span class="item_name" style="width: 120px;"></span> 
							    <input type="button" class="link_btn" onclick="uploadImg('fileId')" value="上传" /> 
							    <img id="popPictureImg" alt="" src="" width="100px" height="50px" style="padding-left: 10px;">
							</li>
						</ul> -->
						<ul class="ulColumn2" style="text-align: left;">
							<li><span class="item_name" style="width: 120px;">上传文件：</span>
								<input type="file" id="filePdfId" name="filePdfId" />
							</li>
							<li><span class="item_name" style="width: 120px;"></span> 
								<input type="button" class="link_btn" onclick="uploadPdf('filePdfId')" value="上传" /> <label id="popPdf"></label>
							</li>
						</ul>
					</form>
				</div>
