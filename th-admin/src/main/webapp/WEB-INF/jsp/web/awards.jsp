...
<title>天虹</title>
	...
	<script src="${basePath }/js/web/awards.js?ver=${ver}" type="text/javascript"></script>
		...
		<div class="rt_content">
			...
			<div class="pop_cont">
				...
				<div class="pop_cont_input">
					<ul>
						<li>
							<span style="width: 70px; text-align: right;" class="ttl">获奖名称:</span>
							<input id="popTitle" style="width: 140px;" type="text" placeholder="请输入菜单名..." class="textbox" />
						</li>
						<li>
							<span style="width: 70px; text-align: right;" class="ttl">授予时间:</span>
