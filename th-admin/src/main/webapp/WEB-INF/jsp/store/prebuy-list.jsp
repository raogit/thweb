...
<head>
	...
	<script src="${basePath }/js/store/prebuy-list.js?ver=${ver}" type="text/javascript" ></script>
...
<!-- 					<li><span style="width:70px;text-align: right;" class="ttl">后台链接:</span><input id="popUrl"  style="width:140px;" type="text" placeholder="请填写url..." class="textbox" /></li> -->
		...
		<section>
			<section>
				...
				<strong style="color: grey;">预购商品名:</strong>
				<input id="name" type="text" class="textbox" placeholder="预购商品名..." /> 
