...
<head>
	...
	<script src="${basePath }/js/store/newproduct-list.js?ver=${ver}" type="text/javascript" ></script>
...
<body>
	...
	<div class="rt_content">
		...
		<div class="pop_cont">
			...
			<!--content-->
			<input type="hidden" value="0" id="popNewProductId" />
			<input type="hidden" value="0" id="picture" name="picture"/>
			<div class="pop_cont_input">
				<ul>
					<li><span style="width:70px;text-align: right;" class="ttl">新品名:</span> <input id="popName" style="width:140px;" type="text" placeholder="请输入菜单名..." class="textbox" /></li>
					<li><span style="width:70px;text-align: right;" class="ttl">描述:</span> <textarea id="popDescriber" rows="10" cols="50"></textarea></li>
...
<!-- 					<li><span style="width:70px;text-align: right;" class="ttl">后台链接:</span><input id="popUrl"  style="width:140px;" type="text" placeholder="请填写url..." class="textbox" /></li> -->
		...
		<section>
			<section>
				...
				<strong style="color: grey;">新品名:</strong>
				<input id="name" type="text" class="textbox" placeholder="新品名..." /> 
