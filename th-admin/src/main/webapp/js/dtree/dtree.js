...
function dTree(objName) {
	...
	this.icon = {
		root				: basePath + '/img/dtree/base.gif',
		folder			: basePath + '/img/dtree/folder.gif',
		folderOpen	: basePath + '/img/dtree/folderopen.gif',
		node				: basePath + '/img/dtree/page.gif',
		empty				: basePath + '/img/dtree/empty.gif',
		line				: basePath + '/img/dtree/line.gif',
		join				: basePath + '/img/dtree/join.gif',
		joinBottom	: basePath + '/img/dtree/joinbottom.gif',
		plus				: basePath + '/img/dtree/plus.gif',
		plusBottom	: basePath + '/img/dtree/plusbottom.gif',
		minus				: basePath + '/img/dtree/minus.gif',
		minusBottom	: basePath + '/img/dtree/minusbottom.gif',
		nlPlus			: basePath + '/img/dtree/nolines_plus.gif',
		nlMinus			: basePath + '/img/dtree/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
