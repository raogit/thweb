...
public class CultureServiceImpl implements CultureService {
	...
	// }
	//
	// public Culture insertSelective(int menuId, String title, String content,
	...
	// }
	//
	// public List<Culture> insertSelective(int menuId, String title, String
	// content, List<String> paths, User user)
	// throws Exception {
