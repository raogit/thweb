			...
			<div class="i-btm-in">
				...
				<div class="i-b-mid">
					<ul class="i-b-ul">
						...
						<li><a href="culture/Ejournals.html"><img src="images/img/i_2.png" alt=""><p>天虹期刊</p></a></li>
						<li><a href="culture/Public.html"><img src="images/img/i_3.png" alt=""><p>天虹公益</p></a></li>
					</ul>
				</div>
				<div class="i-b-r">
