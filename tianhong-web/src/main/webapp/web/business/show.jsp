...
<body>
	...
	<div class="bodyer">
		<div class="titleImg_content"
			style="background: url(../images/bs2.jpg) no-repeat center; background-size: cover; filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(. ./images/bs2.jpg, sizingMethod='scale');">
			<div class="titleImg_img">
				<img src="../images/bs8.png">
			</div>
		</div>
		...
		<div class="show_content">
			<div class="show_contentBox">
				<div class="showTop">
					<ul>
						<li class="wth cur1">品牌展示</li>
						<li class="wth2"></li>
						<li class="wth1">项目展示</li>
					</ul>
				</div>
