					    ...
					    <div class="bd-LE-top">
		                    ...
		                    <div class="bd-LE-tl fl">
		                       <%--  <div class="bd-LE-num">${item.createTimeStr }</div> --%>
		                        <div style="color:#e9a171;" class="bd-LE-ch">${item.title }</div>
	                ...
	                <div class="bd-LE-btm">
	                    <ul class="bd-LE-list">
	                    	<c:forEach var="item" items="${pictures }" begin="1" step="1" end="4" varStatus="itemStatus">
				                <li>
		                            <div class="LE-lr fr">
		                                <div class="LE-lrt"><span  style="color:#e9a171;" >${item.title }</span></div>
		                                <div class="LE-lrc">${item.content }</div>
		                                <div class="LE-lrm"><a style="color:#666666;" target="_blank" href="${basePath}/web/culture/edetails?fileName=${item.url}" class="bd-LE-a">查看更多</a></div>
		                            </div>
